    ...
    ui(new Ui::FmProjectSettings)
{
    ...
    radioPslPrefix.setRadio(tr::PrefixSuffixMode::OFF,  ui->radioPslPrefOff);
    radioPslPrefix.setRadio(tr::PrefixSuffixMode::DFLT, ui->radioPslPrefDefault);
...
void FmProjectSettings::copyFrom(const tr::PrjInfo& x)
{
    ...
    radioPslPrefix.set(x.transl.pseudoloc.prefixSuffixMode);
}
...
void FmProjectSettings::copyTo(tr::PrjInfo& r)
{
    ...
    if (r.isTranslation()) {
        ...
        r.transl.pseudoloc.prefixSuffixMode = radioPslPrefix.get();
